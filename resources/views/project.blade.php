          ...
          <div class="container">
             ...
             <div class="row">
                ...
                <button class="col-md-4" >
                   <div class="col-md-5">
                      <img src="images/Azimi.png" alt="" class="img-responsive w-25 border-rounded mt-2 ">
                   </div>
                   <div class="col-md-7">
                      <label for="">NoorAhmad</label>
                      <label for="">Azimi</label>
                      <h5 class="htt">web</h5>
                      </div>
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2022 All Rights Reserved. <a href="https://www.gmail.com/noorahmadazime@gmail.com/"> Noor Ahmad Azimi</a></p>
                     </div>
                  </div>
               </div>
            </div>
