                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="/studentIndex"><img src="images/finalLOgo.PNG" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              ...
                              <li class="nav-item ">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="/login">NEW STUDENTS</a>
                                 </li>
                                 <li class="nav-item">
               ...
               <table class="table col-md-10">
                  ...
                  <tbody class="col-md-10">
                    <tr>
                     ...
                     <td>Ahmad</td>
                     <td>Ahmadi</td>
                     <td>ahmadahmadi@gmail.com</td>
                     <td>Herat Farqa str 12 ave</td>
                     <td>Mobile App</td>
                    ...
                    <tr>
                     <td>Mohammad</td>
                     <td>Mohammadi</td>
                     <td>mohammadmohammadi@yahoo.com</td>
                     <td>Herat mostufiyad str 23 ave</td>
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2022 All Rights Reserved. <a href="www.gmail.com/noorahmadazime@gmail.com"> Noor Ahmad Azimi</a></p>
                     </div>
                  </div>
               </div>
            </div>
