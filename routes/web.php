...
Route::get('/stProject', function(){
     $st = Student_Projects::all();
    return view('stProjects', compact('st'));
});

Route::post('saveProject',[stuent_project::class, 'saveall']);
Route::get('edit/{id}',[stuent_project::class, 'editall']);
Route::put('edit/{id}',[stuent_project::class, 'updateall'] );
